...
const process_reference_1 = require("./app/actions/process-reference");
async function testShortsErrorHandling() {
    ...
    for (let i = 0; i < testUrls.length; i++) {
        ...
        try {
            ...
            const metadata = await (0, process_reference_1.extractYouTubeMetadata)(url);
            ...
            const referenceContent = await (0, process_reference_1.processReferenceContent)(source, 'shorts', '繁體中文', true // Use structured output
            );
